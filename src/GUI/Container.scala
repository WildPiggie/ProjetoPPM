...
object Container {
   ...
   * @param path the path name of the image
   * @param container the container
   * @return next element in the container's list
   */
   ...
   * @param path the path name of the image
   * @param container the container
   * @return previous element in the container's list
   */
  ...
  def switch(path1: String, path2:String)(container: Container) : Container = {
    val index1 = container.data.indexWhere(x => x._1.equals(path1))
    val index2 = container.data.indexWhere(x => x._1.equals(path2))
   ...
   * @param path the path name of the image
   * @param container the container
   * @return the info String of the specified image
   */
   ...
   * @param container the container
   * @return the path String of the specified image
   */
